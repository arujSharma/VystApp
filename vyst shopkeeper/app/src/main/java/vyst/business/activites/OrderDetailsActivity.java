...
public class OrderDetailsActivity extends AppCompatActivity {
    ...
    public void init(){
        ...
        orderItemsAdapter = new OrderItemsAdapter(OrderDetailsActivity.this);
        final RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(OrderDetailsActivity.this);
